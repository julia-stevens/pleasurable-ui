...
* [`app.get("/speakers")`](https://github.com/julia-stevens/pleasurable-ui/blob/5000c2aa2f32097773d773616150c88959d21ba3/server.js#L153-L190): Haalt alle sprekers op, toont bookmarks (op basis van `Bookmark for Julia`) en ondersteunt filtering op "all" of "bookmarked". Wordt weergegeven in `speakers.liquid`.
* [`app.get("/speakers/:slug")`](https://github.com/julia-stevens/pleasurable-ui/blob/5000c2aa2f32097773d773616150c88959d21ba3/server.js#L253-L265): Laadt de detailpagina van een specifieke spreker (inclusief gerelateerde webinars) in `speakers-detail.liquid`.
* [`app.post("/speakers")`](https://github.com/julia-stevens/pleasurable-ui/blob/5000c2aa2f32097773d773616150c88959d21ba3/server.js#L192-L238): Verwerkt het bookmarken of unbookmaken van een spreker. Controleert op duplicatie en gebruikt `_method=DELETE` voor verwijderacties.
* [`app.post("/speakers/:id/unbookmark")`](https://github.com/julia-stevens/pleasurable-ui/blob/5000c2aa2f32097773d773616150c88959d21ba3/server.js#L240-L251): Verwijdert expliciet een bookmark voor een spreker op basis van ID, met redirect naar de juiste filter.
